...
class StudentExamRelationManager extends RelationManager
{
    protected static string $relationship = 'StudentExam';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('lecture')
                    ...
                    ->options(fn () => Lecture::all()->pluck('name', 'name')->toArray())
                    ->required(),
            ]);
    }
    ...
    {
        return trans_choice('student_exam', 2);
    }
    ...
    {
        return trans_choice('student_exam', 1);
    }
