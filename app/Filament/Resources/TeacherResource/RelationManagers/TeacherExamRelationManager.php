...
class TeacherExamRelationManager extends RelationManager
{
    protected static string $relationship = 'TeacherExam';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('lecture')
                    ...
                    ->options(fn () => TeacherLecture::all()->pluck('name', 'name')->toArray())
                    ->required(),
            ]);
    }
    ...
    {
        return trans_choice('teacher_exam', 2);
    }
    ...
    {
        return trans_choice('teacher_exam', 1);
    }
