                                        ...
                                        @unless ($loop->first)
                                            <li>
                                                <button
                                                    ...
                                                    <x-heroicon-o-chevron-up class="w-4 h-4" wire:loading.remove.delay
                                                        wire:target="dispatchFormEvent('builder::moveItemUp', '{{ $getStatePath() }}', '{{ $uuid }}')" />

                                                    <x-filament-support::loading-indicator class="w-4 h-4 text-primary-500"
                                                        wire:loading.delay
                                                        wire:target="dispatchFormEvent('builder::moveItemUp', '{{ $getStatePath() }}', '{{ $uuid }}')"
                                                        x-cloak />
                                                </button>
                                        ...
                                        @unless ($loop->last)
                                            <li>
                                                <button
                                                    ...
                                                    <x-heroicon-o-chevron-down class="w-4 h-4" wire:loading.remove.delay
                                                        wire:target="dispatchFormEvent('builder::moveItemDown', '{{ $getStatePath() }}', '{{ $uuid }}')" />
                                    ...
                                    @if ($isCloneable)
                                        <li>
                                            <button
                                                ...
                                                <x-heroicon-o-duplicate class="w-4 h-4" wire:loading.remove.delay
                                                    wire:target="dispatchFormEvent('builder::cloneItem', '{{ $getStatePath() }}', '{{ $uuid }}')" />
                                    ...
                                    @unless ($isItemDeletionDisabled)
                                        <li>
                                            <button title="{{ __('forms::components.builder.buttons.delete_item.label') }}"
                                                ...
                                                wire:loading.attr="disabled" type="button" @class([
                                                ...
                                                <x-heroicon-o-trash class="w-4 h-4" wire:loading.remove.delay
                                                    wire:target="dispatchFormEvent('builder::deleteItem', '{{ $getStatePath() }}', '{{ $uuid }}')" />
                                    ...
                                    @if ($isCollapsible)
                                        <li>
                                            <button
                                                ...
                                                <x-heroicon-o-minus-sm class="w-4 h-4" x-show="! isCollapsed" />

                                                <span class="sr-only" x-show="! isCollapsed">
                                                    {{ __('forms::components.builder.buttons.collapse_item.label') }}
                                                </span>

                                                <x-heroicon-o-plus-sm class="w-4 h-4" x-show="isCollapsed" x-cloak />
