...
@if (count($indicators))
    <div {{ $attributes->class(['filament-tables-filter-indicators bg-gray-500/5 gap-x-4 px-4 py-1 text-sm flex']) }}>
                ...
                @foreach ($filterIndicators as $field => $indicator)
                    ...
                    <span @class([
                        ...
                        <button
                            ...
                            wire:loading.attr="disabled" wire:loading.class="cursor-wait" wire:target="removeTableFilter"
                            type="button"
        ...
        <div class="flex-shrink-0">
            <button wire:click="removeTableFilters" type="button" @class([
                ...
                <div class="w-5 h-5 flex items-center justify-center">
                    <x-heroicon-o-x :x-tooltip.raw="__('tables::table.filters.buttons.remove_all.tooltip')" wire:loading.remove.delay
                        wire:target="removeTableFilters,removeTableFilter" class="w-5 h-5" />
